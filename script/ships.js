const ships = '[{"type":"Carriers","name":"Acclamator-class assault ship","class":"Heavy cuiser","length":"752 meters","width":"460 meters","acceleration":"3.500 G","hyperdrive":"Class 0.6","crew":"700","passengers":"16.000","price":"500"},'+
            '{"type":"Cruisers","name":"Carrack-class light cruiser","class":"Frigate","length":"72 meters","width":"150 meters","acceleration":"80 MGLT","hyperdrive":"Class 1.0","crew":"1.007","passengers":"142","price":"250"},'+
            '{"type":"Cruisers","name":"Dauntless-class heavy cruiser","class":"Heavy cuiser","length":"1200 meters","width":"500 meters","acceleration":"1 MGLT/s","hyperdrive":"Class 0.5","crew":"1.000","passengers":"125","price":"5400"},'+
            '{"type":"Frigates","name":"Interceptor-class frigate","class":"Frigate","length":"150 meters","width":"80 meters","acceleration":"1.2 MGLT/s","hyperdrive":"Class 0.6","crew":"650","passengers":"90","price":"900"},'+
            '{"type":"Gunships","name":"Assassin-class corvette","class":"Corvette","length":"140 meters","width":"59 meters","acceleration":"1.5 MGLT/s","hyperdrive":"Class 2.0","crew":"100","passengers":"60","price":"1100"},'+
            '{"type":"Gunships","name":"Consular-class cruiser","class":"Space cruiser","length":"115 meters","width":"39 meters","acceleration":"2.040 G","hyperdrive":"Class 2.0","crew":"9","passengers":"16","price":"800"},'+
            '{"type":"Starfighters","name":"N-1 starfighter","class":"Luxury starfighter","length":"11 meters","width":"7 meters","acceleration":"3.750 G","hyperdrive":"Class 1.0","crew":"2","passengers":"0","price":"150"},'+
            '{"type":"Starfighters","name":"T-65 X-wing starfighter","class":"Starfighter","length":"12.5 meters","width":"10 meters","acceleration":"3.700 G","hyperdrive":"Class 1.0","crew":"2","passengers":"0","price":"90"}]';
...
document.getElementById('photoimg').style.background = "url('../images/ships/"+obj[1].type+"/"+obj[1].name+".png')";
...
function majElement(index){
    ...
    document.getElementById('photoimg').style.background = "url('../images/ships/"+obj[index].type+"/"+obj[index].name+".png')";
    document.getElementById('photoimg').style.backgroundSize = "contain"; 
    document.getElementById('photoimg').style.backgroundRepeat = "no-repeat"; 
